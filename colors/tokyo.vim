" Vim color file
" cyberpunk
" Created by Kaspars Smilga with ThemeCreator (https://github.com/mswift42/themecreator)
...
let s:bg3="#48403f"
let s:bg4="#595252"
let s:keyword="#50b8db"
let s:builtin="#f0e904"
let s:const= "#56775a"
let s:comment="#875843"
let s:func="#f0e904"
let s:str="#988556"
let s:type="#f0e904"
let s:var="#afb7b1"
...
exe 'hi SignColumn guifg='s:bg' guibg='s:bg
exe 'hi EndOfBuffer guifg='s:fg' guibg='s:bg

exe 'hi GitGutterAdd guifg='s:green
exe 'hi GitGutterChangeDelete guifg='s:red
exe 'hi GitGutterChange guifg='s:red
